...
/**
 * Used to extract a TimeStampMilli value from the context object. This interface enables the use of a pseudo-code generator
 ...
 */
public interface TimeStampMilliExtractor
        extends Extractor
{
    /**
     ...
     */
    void extract(Object context, NullableTimeStampMilliHolder dst) throws Exception;
}
