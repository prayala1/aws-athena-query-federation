        ...
        implements FieldWriter
{
     ...
     */
    public TimeStampMilliFieldWriter(TimeStampMilliExtractor extractor, TimeStampMilliVector vector, ConstraintProjector rawConstraint)
    {
        this.extractor = extractor;
        this.vector = vector;
        if (rawConstraint != null) {
            constraint = (NullableTimeStampMilliHolder value) -> rawConstraint.apply(value.isSet == 0 ? null : value.value);
        }
        else {
            constraint = (NullableTimeStampMilliHolder value) -> true;
        }
    }
    ...
    {
        boolean apply(NullableTimeStampMilliHolder value);
    }
}
